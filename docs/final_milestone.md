...
graph TB
    ...
    api_client["project_cdhw.api_client<br/>(Utility Library)"]
    ...
    dash_io["project_cdhw.dash_app.io"]
    dash_creation["project_cdhw.dash_app.app_creation"]
    dash_figures["project_cdhw.dash_app.figures"]
